          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              <p className="text-center text-base-content/70 max-w-md">
                Set up your profile to connect with friends and start chatting in real-time with Mingo.
              </p>
              {/* IMAGE PREVIEW */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                ...
                >
                  <option value="">Set your status</option>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Chat Theme</span>
                </label>
                <select
            ...
            <button className="btn btn-primary w-full" disabled={isPending} type="submit">
              {!isPending ? (
                <>
                  <MingoLogo size="5" className="mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
